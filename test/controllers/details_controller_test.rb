...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { cod_value: @detail.cod_value, declare_value: @detail.declare_value, shipment_id: @detail.shipment_id, user_id: @detail.user_id }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { cod_value: @detail.cod_value, declare_value: @detail.declare_value, shipment_id: @detail.shipment_id, user_id: @detail.user_id }
    assert_redirected_to detail_path(assigns(:detail))
  end
